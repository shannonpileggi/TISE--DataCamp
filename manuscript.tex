...
\citep{Baumer2014}. While R software provides users with extraordinary abilities there is no doubt a steep learning curve. To facilitate
...
the exercise, introducing a gamification feature to the learning experience. If they ask for a hint, 30 percent of the available points are deducted;
all points are deducted if they ask for the solution.  If the student completes the exercise without
...
on GitHub and under \texttt{Settings} you can select the \texttt{Collabroators} tab and enter the user names of collaborators.



Newly created GitHub repositories will contain three files: 
