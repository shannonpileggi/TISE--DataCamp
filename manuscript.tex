...
progress (points and chapters completed) as well as the progress of their peers. When students can see the number of available points
...
Figure1 is an example of an exercise in the Teach Editor and figure2 is the corresponding interface for students. Students will read the lesson information and instructions, answer the question, and submit their code.
\begin{figure}
...
Multiple choice exercises use the SCT function called  \texttt{test\_mc} 
which requires two arguments: \texttt{correct} and \texttt{feedback\_msgs}. 
...
The \texttt{feedback\_msgs} argument is a vector of strings that contain feedback 
...
Every DataCamp course is linked through GitHub version control,
allowing statistics educators to easily collaborate and reproduce code. 
