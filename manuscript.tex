...
Courses are available through the DataCamp website and students can access the lesson through their web-browser on their laptop,
...
- 'datacamp/testwhat' to help with submission correctness tests
...
R package called 'testwhat' which acts as a guide to writing and using SCTs (this can be accessed on DataCamp's GitHub repository: 'datacamp/testwhat'). 
...
SCTs have to be specified but sample and solution code do not. DataCamp offers two types of multiple choice questions, simple and regular. The simple multiple 
